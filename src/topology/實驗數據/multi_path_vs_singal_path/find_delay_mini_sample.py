...
def myNetwork():
    ...
    net.addLink(s1, s2,port1=10,port2=10,cls=TCLink, bw=1,jitter="0ms",delay="300ms",loss=0,max_queue_size=None)
    net.addLink(s1, s2,port1=11,port2=11,cls=TCLink, bw=1,jitter="0ms",delay="200ms",loss=0,max_queue_size=None)
