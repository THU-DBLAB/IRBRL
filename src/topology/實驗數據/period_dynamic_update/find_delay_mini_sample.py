...
def myNetwork():
    ...
    net.addLink(s1, s2,port1=10,port2=10,cls=TCLink, bw=1000,jitter="0ms",delay="100ms",loss=0,max_queue_size=None)
    net.addLink(s1, s2,port1=11,port2=11,cls=TCLink, bw=1000,jitter="00ms",delay="100ms",loss=0,max_queue_size=None)
    net.addLink(s1, s2,port1=12,port2=12,cls=TCLink, bw=1000,jitter="0ms",delay="0ms",loss=0,max_queue_size=None)
    net.addLink(s1, s2,port1=14,port2=14,cls=TCLink, bw=1000,jitter="00ms",delay="100ms",loss=0,max_queue_size=None)
